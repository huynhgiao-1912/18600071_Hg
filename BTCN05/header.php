...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <a href="sum.php">Tính tổng <?php echo $title=='Cộng hai số' ?'<span class="sr-only">(curent)</span>': ' '?></a></li>
      <?php if ($currentUser) : ?>
        <li class="nav-item <?php echo $title=='Trang chủ' ? 'active' : '';?>">
      <a href="logout.php"><span class="glyphicon glyphicon-log-in"></span>  Đăng xuất <?php echo $title=='Trang chủ' ?'<span class="sr-only">(curent)</span>': ' '?></a></li>
      <?php else: ?>
